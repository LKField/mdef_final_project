"""dfplayerTest.py is an initial test of the picodfplayer Library by mannbro

This code is directly mannbro on GitHub under a MIT License and can be found at:
https://github.com/mannbro/PicoDFPlayer/blob/main/picodfplayer_example.py
"""
...
print('Playing track 002.mp3 in folder 01')
